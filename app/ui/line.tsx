...
function HeroLine() {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 197.67 12.48'>
      <defs>
        <style>
          {`
            .d {
              ...
              stroke: none; // No stroke for a thinner appearance
            }
          `}
        </style>
      </defs>
